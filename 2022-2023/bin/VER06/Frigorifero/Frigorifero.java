...
public class Frigorifero{
    ...
    public void settemperaturaFrigo(int temperaturaFrigo){
        if(temperaturaFrigo >= -3 && temperaturaFrigo <= 3){
    ...
    public void settemperaturaFrizer(int temperaturaFrizer){
        if(temperaturaFrizer >= -6 && temperaturaFrizer <= 0){
    ...
    public Frigorifero(Frigorifero frigo){
        ...
        this.litriFrizer=frigo.litriFrizer;
        ...
        this.temperaturaFrizer=frigo.temperaturaFrizer;
